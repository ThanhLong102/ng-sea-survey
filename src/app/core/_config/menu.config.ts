    ...
    aside: {
      ...
      items: [
        ...
        },
        {
          ...
          submenu: [
            {
              title: 'Quản lý vai trò User khách hàng',
        ...
        {
          title: 'Phân quyền theo vai trò hệ thống',
          root: true,
          bullet: 'dot',
          icon: 'flaticon2-user-outline-symbol',
          page: '/menu-role'
...
export const MenuList: any =
  [{
    ...
    title: 'Dịch vụ thu tiền hàng COD'
  },
  ]
